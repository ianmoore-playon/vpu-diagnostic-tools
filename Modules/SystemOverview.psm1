...
function Build-SystemOverviewPanel {
    $script:pnlSysOverview = New-Object System.Windows.Forms.Panel
    $script:pnlSysOverview.Size      = New-Object System.Drawing.Size($WideW, $ContentH)
    $script:pnlSysOverview.Location  = New-Object System.Drawing.Point($SideW, $HdrH)
    $script:pnlSysOverview.BackColor = $ColBg
    $script:pnlSysOverview.Anchor    = $AnchorTLRB
    $form.Controls.Add($script:pnlSysOverview)
    ...
    $script:pnlSysOverview.Controls.Add($lblHubTitle)
    ...
    $script:pnlSysOverview.Controls.Add($lblHubSub)
    ...
    foreach ($hc in $hubCardDefs) {
        ...
        $script:pnlSysOverview.Controls.Add($cp)
    ...
    $script:pnlSysOverview.Controls.Add($btnHubRun)
    ...
    $script:pnlSysOverview.Controls.Add($btnHubLastReport)

    $btnHubRun.Add_Click({ $navCamera.PerformClick(); $script:btnRun.PerformClick() })
