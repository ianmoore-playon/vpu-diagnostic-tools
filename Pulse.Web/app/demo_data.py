...
DEMO = {
    ...
    "Test-NetworkDomains.ps1": lambda **kw: {
        "results": [
            ...
            {"domain": "app.singular.live", "resolvedTo": "76.76.21.21", "status": "pass", "resolutionMs": round(random.uniform(12, 40), 1)},
    ...
    "Get-NetworkHealth.ps1": lambda **kw: {
        ...
        "connections": [
            ...
            {"localPort": 49220, "remoteAddr": "76.76.21.21", "remotePort": 443, "remoteHost": "app.singular.live", "state": "Established", "pid": 6010},
    ...
    "Start-NetworkCapture.ps1": lambda **kw: {
        ...
        "topTalkers": [
            ...
            {"remoteAddr": "76.76.21.21", "remotePort": 443, "remoteHost": "app.singular.live", "packets": random.randint(20, 80)},
        ],
        "findings": [
