...
DEMO = {
    ...
    "Get-ScoreConnectStatus.ps1": lambda **kw: {
        ...
        "liveScoreData": {
            ...
            "homeFouls": random.randint(0, 9),
            "awayFouls": random.randint(0, 9),
            "homeTimeouts": random.randint(0, 5),
            "awayTimeouts": random.randint(0, 5),
            "possession": random.choice(["home", "away", None]),
            "homeBonus": random.choice([True, False]),
            "awayBonus": random.choice([True, False]),
        },
