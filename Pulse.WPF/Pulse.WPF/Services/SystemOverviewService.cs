...
{
    /// <summary>
    /// Pure-C# port of SystemOverview.psm1's home-tile + last-run-summary logic.
    /// Tile copy and ordering match the WinForms hub layout one-for-one.
    /// </summary>
    public class SystemOverviewService : ISystemOverviewService
    {
        ...
        {
            new HubTileViewModel { Title="System Overview",        Description="Hardware specs, OS version, uptime, and Pixellot software versions.",      IconKey="Information",      TargetNav="SystemOverview" },
